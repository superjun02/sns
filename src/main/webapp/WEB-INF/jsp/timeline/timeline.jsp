	...
	<c:forEach items="${cardList}" var="card">
		<div class="timelineBox mt-5">
			<div class="d-flex justify-content-between userNameBox">
				...
				<div class="ml-3">
					<button class="infoBtn" data-post-id="${card.post.id}" data-toggle="modal" data-target="#modal">
					<img alt="이미지 삽입" src="/static/img/more-icon.png" width="28px" height="28px">
					</button>
				</div>
			</div>
			<div>
	...
	<div class="modal-dialog modal-sm modal-dialog-centered">
		<div class="modal-content text-center">
			<div class="border-bottom py-3">
				<a id="postDelete" class="btn text-danger">삭제하기</a>
			</div>
			<div class="py-3">
				<a class="btn" data-dismiss="modal">취소하기</a>
			</div>
		</div>
	</div>
</div>
